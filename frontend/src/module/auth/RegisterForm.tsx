...
const RegisterForm = (props: RegisterFormProps) => {
  ...
  return (
    ...
    >
      ...
      <AnimatedButton
        type="submit"
        className="w-full bg-primary text-white py-2 rounded-lg mt-2 disabled:opacity-60 font-semibold"
        disabled={isLoading}
      ...
      <div className="mt-4">
        ...
        <div className="mt-4 flex gap-3">
          <AnimatedButton
            type="button"
            className="flex-1 flex items-center justify-center gap-2 rounded-full bg-surface-container-high py-2 text-sm font-medium shadow-sm"
            rippleColor="bg-primary/10"
          >
